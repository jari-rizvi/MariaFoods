...
@AndroidEntryPoint
class TermsCondtionFragment : BaseFragment<FragmentTermssConditionBinding, HelpViewModel>() {

    override val layoutId: Int
        get() = com.teamx.mariaFoods.R.layout.fragment_termss_condition
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mViewModel.termsConditions()
        mViewModel.termsConditionResponse.observe(requireActivity()) {
            when (it.status) {
            ...
            if (isAdded) {
                mViewModel.termsConditionResponse.removeObservers(viewLifecycleOwner)
            }
        }
