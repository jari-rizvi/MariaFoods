...
import com.teamx.mariaFoods.databinding.FragmentLoginPhoneBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class LogInPhoneFragment :
    BaseFragment<FragmentLoginPhoneBinding, LoginViewModel>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mViewDataBinding.btnNext.setOnClickListener {
            ...
            navController.navigate(R.id.otpRegisterFragment, null, options)
        }
