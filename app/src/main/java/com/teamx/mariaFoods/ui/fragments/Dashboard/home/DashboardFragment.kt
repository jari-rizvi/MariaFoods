...
//import com.teamx.mariaFoods.data.dataclasses.products.Variation
...
//
//                                                val data =
//                                                    com.teamx.mariaFoods.data.dataclasses.getAddress.Data(
//                                                        address_1 = Data.getJSONObject(i)
//                                                            .getString("address_1"),
//                                                        address_2 = Data.getJSONObject(i)
//                                                            .getString("address_2"),
//                                                        city = Data.getJSONObject(i)
//                                                            .getString("city"),
//                                                        country = Data.getJSONObject(i)
//                                                            .getString("country"),
//                                                        id = Data.getJSONObject(i).getInt("id"),
//                                                        is_default = Data.getJSONObject(i)
//                                                            .getInt("is_default"),
//                                                        lat = Data.getJSONObject(i)
//                                                            .getString("lat"),
//                                                        long = Data.getJSONObject(i)
//                                                            .getString("long"),
//                                                        name = Data.getJSONObject(i)
//                                                            .getString("name"),
//                                                        postal = Data.getJSONObject(i)
//                                                            .getString("postal"),
//                                                        state = Data.getJSONObject(i)
//                                                            .getString("state"),
//                                                        user_id = Data.getJSONObject(i)
//                                                            .getInt("user_id")
//
//                                                    )
//
...
//                                }
//                                if (isAdded) {
//                                    mViewModel.addressList.removeObservers(
//                                        viewLifecycleOwner
//                                    )
//                                }
//                            }
...
//                            val jsonObject = JSONObject(data.toString())
//                            val Flag = jsonObject.getInt("Flag")
//                            val Shedule = jsonObject.getJSONArray("shedule")
//                            val Data = jsonObject.getJSONArray("data")
//
//
//                            for (i in 0..(Data.length() - 1)) {
//
//                                val data = com.teamx.mariaFoods.data.dataclasses.products.Data(
//                                    description = Data.getJSONObject(i).getString(" description"),
//                                    discount_end_date = Data.getJSONObject(i)
//                                        .getString(" discount_end_date"),
//                                    discount_start_date = Data.getJSONObject(i)
//                                        .getString(" discount_start_date"),
//                                    discount_type = Data.getJSONObject(i)
//                                        .getString(" discount_type"),
//                                    discount_value = Data.getJSONObject(i)
//                                        .getInt(" discount_value"),
//                                    feature_image = Data.getJSONObject(i)
//                                        .getString(" feature_image"),
//                                    id = Data.getJSONObject(i).getInt(" id"),
//                                    max_price = Data.getJSONObject(i).getInt(" max_price"),
//                                    min_price = Data.getJSONObject(i).getInt(" min_price"),
//                                    name = Data.getJSONObject(i).getString(" name"),
//                                    product_images = Data.getJSONObject(i)
//                                        .getJSONArray("product_images"),
//                                    short_description = Data.getJSONObject(i)
//                                        .getString(" short_description"),
//                                    slug = Data.getJSONObject(i).getString(" slug"),
//                                    stock_qty = Data.getJSONObject(i).getInt(" stock_qty"),
//                                    variation = Data.getJSONObject(i).getJSONObject("variation"),
//                                    isChecked = Data.getJSONObject(i).getBoolean(" isChecked"),
//                                    qty = Data.getJSONObject(i).getInt(" qty")
//                                )
//                            }
//
//                            for (i in 0..(Data.length() - 1)){
...
//                                        R.id.checkoutFragment, null, options
//                                    )
//
//
//                                } else {
