...
interface ApiService {
    ...
    suspend fun loginPhone(@Body params: JsonObject?): Response<JsonObject>

    @Headers("secret: dev")
    @POST(NetworkCallPoints.SOCIAL_LOGIN)
    suspend fun socialLogins(@Body params: JsonObject?): Response<JsonObject>
    ...
    suspend fun signup(@Body params: JsonObject?): Response<JsonObject>
    ...
    suspend fun resetPassEmail(@Body params: JsonObject?): Response<JsonObject>

    @Headers("secret: dev")
    @POST(NetworkCallPoints.RESET_PASS)
    suspend fun resetPass(@Body params: JsonObject?): Response<JsonObject>
...
@Headers("secret: dev")
    ...
    suspend fun otpVerify(@Body params: JsonObject?): Response<JsonObject>

    @Headers("secret: dev")
    @POST(NetworkCallPoints.OTP_VERIFY_FORGOT_EMAIL)
    suspend fun otpVerifForgotEmail(@Body params: JsonObject?): Response<JsonObject>
